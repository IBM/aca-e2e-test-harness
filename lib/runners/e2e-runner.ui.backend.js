...
const setup = (dotenvpath = process.env['DOTENV_PATH']) => {
  const { log, testCases, cfg } = config(dotenv.config({ path: dotenvpath }), {
    ...
    username: process.env[`${process.env.SPACE}_${process.env.ENV}_ui_backend_auth_username`],
    password: process.env[`${process.env.SPACE}_${process.env.ENV}_ui_backend_auth_password`],
    authUrl: process.env[`${process.env.SPACE}_${process.env.ENV}_ui_backend_auth_url`],
    url: process.env[`${process.env.SPACE}_${process.env.ENV}_ui_backend_url`],
    secretOrPrivateKey: process.env[`${process.env.SPACE}_${process.env.ENV}_ui_backend_secretOrPrivateKey`],
    path: process.env[`${process.env.SPACE}_${process.env.ENV}_ui_backend_path`],
    cases: process.env[`${process.env.SPACE}_${process.env.ENV}_ui_backend_cases`],
    skipScriptLines: process.env[`${process.env.SPACE}_${process.env.ENV}_ui_backend_skip_script_lines`],
    profileEmail: process.env[`${process.env.SPACE}_${process.env.ENV}_ui_backend_profile_email`],
    profileCountryCode: process.env[`${process.env.SPACE}_${process.env.ENV}_ui_backend_profile_country_code`],
  });
